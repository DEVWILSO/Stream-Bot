    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            if user.status == "kicked":
                await c.send_message(
                    chat_id=m.chat.id,
                    text="You are banned!\n\n  **Contact Developer [Team_MDL](https://telegram.me/t.me/Team_MDL_Admin_bot) he will help you.**",
            ...
            await c.send_message(
                chat_id=m.chat.id,
                text="**sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ ᴡʀᴏɴɢ. ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [ʙᴏss](https://telegram.me/t.me/Team_MDL_Admin_bot)**",
